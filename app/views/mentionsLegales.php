<?php $title = 'Med It Easy | Mentions légales'; ?>

<?php ob_start(); ?>

<div class="container mentions_legales">
    <h2 class="text-center h2_title col-md-12">Informations légales</h2>
    <h3 class="h3_titles">1. Présentation du site.</h3>
    ...
    <p><strong>Propriétaire</strong> : David Saoud – 058156644542 – 15a, rue de la voûte 56100, Lorient<br />
        ...
        <strong>Hébergeur</strong> : OVH – 3 Bis Avenue de Belle Fontaine, - Hall B, 35510 Cesson-Sévigné<br />

    <h3 class="h3_titles">2. Conditions générales d’utilisation du site et des services proposés.</h3>
    <p>L’utilisation du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> implique l’acceptation pleine et
        entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont
        susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>
    ...
    <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de maintenance
        technique peut être toutefois décidée par David Saoud, qui s’efforcera alors de communiquer préalablement aux
        utilisateurs les dates et heures de l’intervention.</p>
    <p>Le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> est mis à jour régulièrement par Mr. David
        Saoud. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins
        à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>
    <h3 class="h3_titles">3. Description des services fournis.</h3>
    <p>Le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> a pour objet de fournir une information
        concernant l’ensemble des activités de la société.</p>
    <p>David Saoud s’efforce de fournir sur le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> des
    ...
    <p>Tous les informations indiquées sur le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> sont données
        à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
            href="http://www.mediteasy.fr/">www.mediteasy.fr</a> ne sont pas exhaustifs. Ils sont donnés sous réserve
        de modifications ayant été apportées depuis leur mise en ligne.</p>
    <h3 class="h3_titles">4. Limitations contractuelles sur les données techniques.</h3>
    ...
    <h3 class="h3_titles">5. Propriété intellectuelle et contrefaçons.</h3>
    <p>David Saoud est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les
    ...
    <h3 class="h3_titles">6. Limitations de responsabilité.</h3>
    <p>David Saoud ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
        l’utilisateur, lors de l’accès au site www.mediteasy.fr, et résultant soit de l’utilisation d’un matériel ne
        répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
    <p>David Saoud ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de
        marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>.</p>
    <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
        utilisateurs. David Saoud se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé
        dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions
        relatives à la protection des données. Le cas échéant, David Saoud se réserve également la possibilité de
    ...
    <h3 class="h3_titles">7. Gestion des données personnelles.</h3>
    ...
    <p>A l'occasion de l'utilisation du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>, peuvent êtres
        recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>,
        le fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
    <p> En tout état de cause David Saoud ne collecte des informations personnelles relatives à l'utilisateur que pour
        le besoin de certains services proposés par le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>.
        L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même
        à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>
    ...
    <p>Aucune information personnelle de l'utilisateur du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>
        n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des
        tiers. Seule l'hypothèse du rachat de David Saoud et de ses droits permettrait la transmission des dites
        informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de
        modification des données vis à vis de l'utilisateur du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a>.</p>
    ...
    <h3 class="h3_titles">8. Liens hypertextes et cookies.</h3>
    <p>Le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> contient un certain nombre de liens hypertextes
        vers d’autres sites, mis en place avec l’autorisation de David Saoud. Cependant, David Saoud n’a pas la
        possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité
        de ce fait.</p>
    <p>La navigation sur le site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> est susceptible de provoquer
        l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier de petite taille, qui
        ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation
        d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le
    ...
    <h3 class="h3_titles">9. Droit applicable et attribution de juridiction.</h3>
    <p>Tout litige en relation avec l’utilisation du site <a href="http://www.mediteasy.fr/">www.mediteasy.fr</a> est
        soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de Paris.</p>
    <h3 class="h3_titles">10. Les principales lois concernées.</h3>
    ...
    <h3 class="h3_titles">11. Lexique.</h3>
