...
<div id="offCanva">
    ...
    <div id="content">
        ...
        <p class="text-center margin selectType">Vous êtes sur la page listant les horaires de vos consultations.</p>
    ...
    <nav id="offCanvaNav">
        ...
        <li><a href="fr/accueil"><i class="fas fa-home fa-1x"></i> Accueil</a></li>
            ...
            <li><a href="fr/tarifs"><i class="far fa-clock fa-1x"></i> Horaires</a></li>
